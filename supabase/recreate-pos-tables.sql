-- ПЕРЕСТВОРЕННЯ POS ТАБЛИЦЬ З ПРАВИЛЬНОЮ СТРУКТУРОЮ
-- Виконайте цей скрипт в Supabase SQL Editor

-- ========================================
-- КРОК 1: Видалення існуючих таблиць (якщо вони є)
-- ========================================
DROP TABLE IF EXISTS order_items CASCADE;
DROP TABLE IF EXISTS orders CASCADE;
DROP TABLE IF EXISTS customers CASCADE;

SELECT 'Старі таблиці видалені' as status;

-- ========================================
-- КРОК 2: Створення таблиці клієнтів
-- ========================================
...
-- ========================================
-- КРОК 3: Створення таблиці замовлень
-- ========================================
CREATE TABLE orders (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
    business_id UUID NOT NULL REFERENCES businesses(id) ON DELETE CASCADE,
...
-- ========================================
-- КРОК 4: Створення таблиці товарів замовлення
-- ========================================
...
-- ========================================
-- КРОК 5: Додавання колонки image_url до products
-- ========================================
DO $$ 
BEGIN
...
-- ========================================
-- КРОК 8: Створення RLS політик для customers
-- ========================================
...
-- ========================================
-- КРОК 9: Створення RLS політик для orders
-- ========================================
...
-- ========================================
-- КРОК 10: Створення RLS політик для order_items
-- ========================================
...
-- ========================================
-- КРОК 11: Додавання тестових даних
-- ========================================
...
-- ========================================
SELECT 
    'POS таблиці успішно перестворено!' as status,
    (SELECT COUNT(*) FROM customers) as customers_count,
    (SELECT COUNT(*) FROM orders) as orders_count,
    (SELECT COUNT(*) FROM order_items) as order_items_count;

-- Перевірка структури
SELECT '=== ФІНАЛЬНА ПЕРЕВІРКА СТРУКТУРИ ===' as info;
SELECT 
